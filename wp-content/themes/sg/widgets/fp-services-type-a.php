...
class SG_Services_Type_A extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'sg_services_widget', 'description' => __( 'Show what services you are able to provide.', 'sg') );
        parent::__construct(false, $name = __('Sg FP: Services Type A', 'sg'), $widget_ops);
		$this->alt_option_name = 'sg_services_widget';
